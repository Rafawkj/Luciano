...
3. **Previsão honesta:** tocar/hover em qualquer entidade mostra sua intenção de Pulso; um botão "Prever Pulso" mostra a resolução fantasma inteira (feature-assinatura; também é a ferramenta didática nº 1).
...
- Acessibilidade: daltonismo (padrões além de cor nas tags), leitura de tela nos menus, tamanho de fonte, redução de movimento (Pulso instantâneo), remapeamento completo no PC.
...
- **O Pulso como espetáculo:** a luz do tabuleiro "respira" quando a fase começa; câmera faz micro-push-ins nas caçadas; o mundo é o VFX.
...
- **Ritmo de partida:** intensidade da trilha segue um "diretor de tensão" (Vitalidade dos Corações + proximidade de Marcos); o Pulso tem tema rítmico próprio que acelera no late game.
...
- **As 12 facções** são "humores" do continente (Doc. 08); a campanha conta a primeira Grande Regência em 30 missões, uma dor de cabeça diplomática por vez, com o humor vindo de personagens (o Texugo sindicalizado, a burocracia solar) e NUNCA de quebra de quarta parede que barateie as apostas.
- **Tom de texto:** flavor de 1 linha, sempre com um sorriso de canto (ver as 150 cartas); nomes próprios pronunciáveis em PT/EN/ES (localização planejada desde o design).
