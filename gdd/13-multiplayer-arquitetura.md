...
- Overlay de caster com "linhas de ameaça" (alcances, Instintos armados e Pavios — mostra o que PODE acontecer: drama instantâneo para narração).
...
- **Risco: animações de Crepúsculo/Instintos somadas a rodadas longas.** *Mitigação:* velocidade 1×/2×/instantânea (ranked default 2×); animações paralelas, nunca sequenciais por entidade.
